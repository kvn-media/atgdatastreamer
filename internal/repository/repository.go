...
type DataTankRepositoryImpl struct {
	db *sql.DB
}

// NewDataTankRepository inisialisasi DataTankRepository
func NewDataTankRepository(db *sql.DB) *DataTankRepositoryImpl {
	return &DataTankRepositoryImpl{db: db}
}

// CreateDataTank membuat data baru di database
func (r *DataTankRepositoryImpl) CreateDataTank(dataTank *models.DataTank) error {
...
func (r *DataTankRepositoryImpl) GetDataTanks() ([]*models.DataTank, error) {
...
func (r *DataTankRepositoryImpl) UpdateDataTank(dataTank *models.DataTank) error {
...
func (r *DataTankRepositoryImpl) DeleteDataTank(id int) error {
